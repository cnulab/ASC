...
from datasets import TripletDataset,ValidationDataset
...
def training(args):
    ...
    save_dir = "triplet_{}".format(backbone)
    ...
    tri_criterion = TripletLoss(margin=margin).cuda()
